      ...
      <ol id="TermsOfUseList">
        <li>
          ...
          <p>
            ...
            not agree, you must cease all use immediately.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            liability, or demand arising out of your use of the Site or
        ...
        <li>
          ...
          <p>
            ...
            be brought in the state or federal courts located in United State of
            America, Michigan
          </p>
        </li>
        <li>
